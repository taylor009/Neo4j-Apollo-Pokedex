    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            object = _ref2.object, params = _ref2.params, context = _ref2.context, resolveInfo = _ref2.resolveInfo, debugFlag = _ref2.debugFlag;
...
var parseRepresentation = function parseRepresentation(_ref17) {
  ...
  if (typeName === undefined) {
    throw new _apolloServer.ApolloError('Missing __typename key');
...
var buildArguments = function buildArguments(_ref25) {
  ...
  var mergedVariableValues = _objectSpread({}, keyVariableValues, {}, variableValues);
...
var getSelectionSet = function getSelectionSet(_ref29) {
  ...
  if (!(0, _keys["default"])(selectionSet).length) {
    throw new _apolloServer.ApolloError("Failed to extract the expected selectionSet for the entity ".concat(typeName));
  }
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      return _context3.abrupt("return", _objectSpread({}, object, {}, entityData));
